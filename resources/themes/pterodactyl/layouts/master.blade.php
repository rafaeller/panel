...
<html>
    <head>
		...
		<!-- Hotjar Tracking Code for enxadahost.com -->
		<script>
			(function(h,o,t,j,a,r){
				h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
				h._hjSettings={hjid:1438713,hjsv:6};
...
<script>(function(){var w=window;var ic=w.Intercom;if(typeof ic==="function"){ic('reattach_activator');ic('update',w.intercomSettings);}else{var d=document;var i=function(){i.c(arguments);};i.q=[];i.c=function(args){i.q.push(args);};w.Intercom=i;var l=function(){var s=d.createElement('script');s.type='text/javascript';s.async=true;s.src='https://widget.intercom.io/widget/ma452y2m';var x=d.getElementsByTagName('script')[0];x.parentNode.insertBefore(s,x);};if(w.attachEvent){w.attachEvent('onload',l);}else{w.addEventListener('load',l,false);}}})();</script>
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu tree" data-widget="tree">
                        ...
                        <hr class="my-3">
                            ...
                            @endcan
                            <li @if(starts_with(Route::currentRouteName(), 'server.dns.index' )) class="active" @endif>
                                <a href="{{ route('server.dns.index', $server->uuidShort)}}">
                                    <i class="fa fa-link color-fa"></i> <span>Gerenciador de Subdomínio</span>
                                </a>
                            </li>
                            @can('view-backup', $server)
                                ...
                                >
                                    <a class="nav-link" href="{{ route('server.backup', $server->uuidShort)}}">
                                        <i class="fa fa-folder color-fa"></i> <span>Backup</span>
                                    </a>
                                </li>
                            @endcan
                            @if(Gate::allows('view-startup', $server) || Gate::allows('access-sftp', $server) ||  Gate::allows('view-allocations', $server))
                                ...
                                ">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        @endcan
                                        @if ($server->egg_id == 2 || $server->egg_id == 3 || $server->egg_id == 4 || $server->egg_id == 5)
                                            <li class="{{ Route::currentRouteName() !== 'server.settings.version' ?: 'active' }}"><a href="{{ route('server.settings.version', $server->uuidShort) }}"><i class="fa fa-angle-right"></i> Alterar Versão</a></li>
                                        @endif
                                    </ul>
                                </li>
                            @endif
